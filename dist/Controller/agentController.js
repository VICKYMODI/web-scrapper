...
const Agent_2 = require("../models/Agent");
const nodemailer_1 = require("../utils/nodemailer");
const Jwt = require("jsonwebtoken");
const env_1 = require("../environment/env");
const LoggedIn_1 = require("../models/LoggedIn");
class agentController {
    static login2(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const password = req.query.password;
            const agent = req.agent;
            let token;
            try {
                const loginStatus = yield LoggedIn_1.default.findOneAndUpdate({
                ...
                if (loginStatus) {
                    ...
                    token = Jwt.sign({ Username: agent.Username, PersonalEmail: agent.PersonalEmail, agent_id: agent._id }, env_1.getEnvironmentVariable().jwt_secret, { expiresIn: '1d' });
                    yield agentController.updateLoginTabel(agent, token);
    ...
    static signup(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const varificationOtp = Utils_1.Utils.generateVarificationToken();
            //agentdata start
            ...
            try {
                ...
                let user = yield new Agent_1.default(newAgentData).save();
                res.send({
                    status_code: 200,
                    data: user
                });
    ...
    static verify(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const agent = yield Agent_2.default.findOneAndUpdate({
                    "PersonalEmail": email,
    ...
    static resendVerification(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const email = req.agent.PersonalEmail;
            const verificationToken = Utils_1.Utils.generateVarificationToken();
            try {
                const agent = yield Agent_2.default.findOneAndUpdate({ "PersonalEmail": email }, {
                    varification_token: verificationToken,
                    verification_token_time: Date.now() + new Utils_1.Utils().max_Token_Time
                }, { new: true });
                if (agent) {
    ...
    static editAgent(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            const ID = req.params.id;
            console.log("test", ID);
            try {
                const updateAgent = yield Agent_2.default.findOneAndUpdate({ "_id": ID }, {
                    //start modification
                    ID: req.body.ID,
                    updated_at: new Date(),
    ...
    static getAllAgents(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const getAllAgents = yield Agent_2.default.find();
                if (getAllAgents) {
    ...
    static updateLoginTabel(agent, token) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const newLogindata = {
                    token: token,
                ...
                let newLoginSession = yield new LoggedIn_1.default(newLogindata).save();
            }
            catch (e) {
                throw new Error(e);
            }
